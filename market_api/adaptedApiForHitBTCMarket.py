...
from market_api.apiForHitBTCMarket import PublicRequests
...
class Public(PublicRequests):
    ...
    def requestTicker(forCryptoCoin: str, forCurrencyCoin: str, fromURL: str):
        ...
        pairSymbol = Public.__getTradePairSymbol(forCryptoCoin, forCurrencyCoin)
    ...
    def requestTrades(forCryptoCoin: str, forCurrencyCoin: str, fromURL: str, withRowLimit=999):
        ...
        def convert(tradeResponse):
            tradePair = Public.__getTradePairSymbol(forCryptoCoin, forCurrencyCoin)
    ...
    @staticmethod
    def __getTradePairSymbol(fromCryptoCoin: str, fromCurrencyCoin: str) -> str:
        return f"{fromCryptoCoin}_{fromCurrencyCoin}".lower()
