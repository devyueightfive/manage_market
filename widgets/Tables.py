...
from shared_data import balance as shared_balance
from wallet.wallet_model import OrderModel, BalanceModel
...
class OrdersTable(QtWidgets.QTableWidget):
    ...
    def setupContextMenu(self):
        ...
        main_window = wallet_widget.parent()
        self.addAction(main_window.add_order_action)
        self.addAction(main_window.cancel_order_action)
