...
favoriteUsers = ['VentureCoinist', 'CryptoHustle', 'cryptodemedici', 'bennydoda01', 'Dmitriysz', 'IOHK_Charles',
                 'Coin_Shark', 'Crypto_Skipper', 'VitalikButerin', 'binance']
...
class TwitterNews:
    ...
    @staticmethod
    def lastTweets(users: list) -> list:
